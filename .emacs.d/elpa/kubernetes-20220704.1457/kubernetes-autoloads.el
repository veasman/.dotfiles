...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "kubernetes-el-tramp" '("get--tramp-file-path" "kubernetes-tramp-")))
...
;;;***

;;;### (autoloads nil "kubernetes-resources" "kubernetes-resources.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from kubernetes-resources.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "kubernetes-resources" '("kubernetes--get-all-groups")))
